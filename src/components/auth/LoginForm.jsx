...
import { ArrowPathIcon, ExclamationCircleIcon, UserIcon, KeyIcon } from '@heroicons/react/24/solid';
...
const LoginForm = () => {
  ...
  // Disable page scroll while on login page
  useEffect(() => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-2 text-sm text-primary-400 dark:text-primary-300">
            {t('auth.loginDescription', 'Sign in to access your dashboard')}
          </p>
        </div>
          ...
          <div className="relative z-10 p-6 sm:p-8">
            <form className="space-y-5" onSubmit={onSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-10 pr-3 py-2.5 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="block w-full pl-10 pr-10 py-2.5 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700/50 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
              ...
              <div className="flex justify-center mt-4 space-x-2">
                <span className="text-sm text-gray-500 dark:text-gray-400">{t('auth.noAccount', "Don't have an account?")}</span>
                <a 
                  href="/register" 
                  className="text-sm font-medium text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300 hover:underline transition-colors"
                >
